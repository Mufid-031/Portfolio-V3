...
export default function CustomizedSteppers() {
  ...
  return (
    <Stack sx={{ width: "100%", height: "200vh", alignItems: "center", paddingTop: "60px", bgcolor: "#2a2a2a", color: "white" }} spacing={4}>
      <Stepper orientation="vertical" activeStep={4} connector={<Connector />} sx={{ display: { xs: "none", lg: "block" }}}>
        <Step data-aos="zoom-in">
          <StepLabel className="relative" StepIconComponent={QontoStepIcon}>
            <div data-aos="fade-left" data-aos-delay="300" className="w-[650px] h-[350px] bg-slate-100 absolute top-5 left-16 rounded-lg"></div>
          </StepLabel>
        </Step>
        <Step data-aos="zoom-in">
          <StepLabel className="relative" StepIconComponent={QontoStepIcon}>
            <div data-aos="fade-right" data-aos-delay="300" className="w-[650px] h-[350px] bg-slate-100 absolute top-5 right-16 rounded-lg"></div>
          </StepLabel>
        </Step>
        <Step data-aos="zoom-in">
          <StepLabel className="relative" StepIconComponent={QontoStepIcon}>
            <div data-aos="fade-left" data-aos-delay="600" className="w-[650px] h-[350px] bg-slate-100 absolute top-5 left-16 rounded-lg"></div>
          </StepLabel>
        </Step>
        <Step data-aos="zoom-in">
          <StepLabel className="relative" StepIconComponent={QontoStepIcon}>
            <div data-aos="fade-right" data-aos-delay="600" className="w-[650px] h-[350px] bg-slate-100 absolute top-5 right-16 rounded-lg"></div>
          </StepLabel>
        </Step>
      </Stepper>
